           ...
           <div className="cart">
               ...
               <div className="content__items">
                   <div className="cart__item">
                       ...
                       <div className="cart__item-info"><h3>Маргарита</h3><p>традиционное, 40 см.</p></div>
                   ...
                   <div className="cart__item">
                       ...
                       <div className="cart__item-price"><b>395 ₽</b></div>
                       <div className="cart__item-remove">
                           <div className="button button--outline button--circle">
                               <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                   ...
                   <div className="cart__item">
                       <div className="cart__item-img"><img className="pizza-block__image"
                                                            ...
                                                            alt="Pizza" /></div>
                       <div className="cart__item-info"><h3>Пепперони</h3><p>традиционное, 40 см.</p></div>
                       <div className="cart__item-count">
                           <button disabled="" className="button button--outline button--circle cart__item-count-minus">
                               <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                       ...
                       <div className="cart__item-price"><b>675 ₽</b></div>
                       <div className="cart__item-remove">
                           <div className="button button--outline button--circle">
                               <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                   ...
                   <div className="cart__item">
                       <div className="cart__item-img"><img className="pizza-block__image"
                                                            ...
                                                            alt="Pizza" /></div>
                       <div className="cart__item-info"><h3>Чизбургер-пицца</h3><p>тонкое, 26 см.</p></div>
                       <div className="cart__item-count">
                           <button disabled="" className="button button--outline button--circle cart__item-count-minus">
                               <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                       ...
                       <div className="cart__item-price"><b>415 ₽</b></div>
                       <div className="cart__item-remove">
                           <div className="button button--outline button--circle">
                               <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
               ...
               <div className="cart__bottom">
                   <div className="cart__bottom-details"><span> Всего пицц: <b>4 шт.</b> </span><span> Сумма заказа: <b>1935 ₽</b> </span>
                   </div>
